...
const NavBar = () => {
  ...
  const changeRole = async () => {
    try {
      ...
      if (data.success) {
        ...
        toast.error(data?.message || "No Authhorized");
      }
    } catch (error) {
  ...
  return (
    <motion.div
      ...
      className={`flex items-center justify-between px-6 md:px-16 lg:px-20 xl:px-32 py-4 text-gray-600 border-b border-borderColor relative gap-2 transition-all ${
